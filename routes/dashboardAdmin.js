...
router.get('/delete/:idMovie', Controller.deleteMovie) // dashboard admin : list movie : update movie


router.get('/listuser/confirm', Controller.listUserToApprove) // dashboard admin : list user butuh approve pembayaran
router.get('/listuser/confirm/:idUser', Controller.changeSubsUser) // dashboard admin : approve pembayaran
